...
src/
  ...
  communities.rs   — Louvain modularity clustering for `sigil communities`
                      (issue #17); cluster_id surface for downstream consumers
...
sigil communities --resolution 1.0         # Louvain file clusters (NDJSON)
